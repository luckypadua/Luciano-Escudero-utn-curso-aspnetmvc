...
using UTNCurso.Core.Validations;
...
builder.Services.AddDefaultIdentity<User>(options => options.SignIn.RequireConfirmedAccount = false)
    ...
    .SetupIdentity();
//builder.Services.AddSingleton<IMapper<TodoItem, TodoItemDto>, TodoItemMapper>();
//#2
...
builder.Services.AddTransient<ITodoClient<TodoItemDto>, TodoClient>();
